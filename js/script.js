...
var myfunc = setInterval(function() {
    ...
    var din = Math.floor(timeleft / (1000 * 60 * 60 * 24));
    var gonta = Math.floor((timeleft % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
    var min = Math.floor((timeleft % (1000 * 60 * 60)) / (1000 * 60));
    var sec = Math.floor((timeleft % (1000 * 60)) / 1000);
    
    document.getElementById("din").innerHTML = din + " "
    document.getElementById("gonta").innerHTML = gonta + " " 
    ...
    if (timeleft < 0) {
        ...
        document.getElementById("gonta").innerHTML = "" 
        document.getElementById("min").innerHTML = ""
        document.getElementById("sec").innerHTML = ""
        document.getElementById("en").innerHTML = "TIME UP!!";
    }
}, 1000);
// =========================== 3RD COUNTDOWN ==========================
...
var myfunc = setInterval(function() {
    ...
    var dy = Math.floor(timeleft / (1000 * 60 * 60 * 24));
    var hy = Math.floor((timeleft % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
    var my = Math.floor((timeleft % (1000 * 60 * 60)) / (1000 * 60));
    var sy = Math.floor((timeleft % (1000 * 60)) / 1000);
    ...
    if (timeleft < 0) {
        ...
        document.getElementById("ey").innerHTML = "TIME UP!!";
    }
}, 1000);
// =========================== FLASHSALE COUNTDOWN ==========================
...
var myfunc = setInterval(function() {
    ...
    document.getElementById("fdays").innerHTML = dy + " "
    document.getElementById("fhours").innerHTML = hy + " " 
    document.getElementById("fmins").innerHTML = my + " " 
    document.getElementById("fsecs").innerHTML = sy + " " 
    
    if (timeleft < 0) {
        clearInterval(myfunc);
        document.getElementById("fdays").innerHTML = ""
        document.getElementById("fhours").innerHTML = "" 
        document.getElementById("fmins").innerHTML = ""
        document.getElementById("fsecs").innerHTML = ""
        document.getElementById("fend").innerHTML = "TIME UP!!";
    }
}, 1000);


// ========================= FEATURED COUNTDOWN END ===================================

// ================= FLASH SALE START ===============
let persent = document.querySelector('.aviliblity_persent')
window.addEventListener("scroll", function(){
this.window.scrollY
console.log(this.window.scrollY);
   let scrolling = window.scrollY
   ...
   if(scrolling > 3900){
       persent.classList.add('aviliblepersent')
    }
    else{
       persent.classList.remove('aviliblepersent')
   }
})
...
$('.flash_slider').slick({
    slidesToShow: 3,
    slidesToScroll: 1,
    prevArrow: '.flsh_left_slid',
    nextArrow: '.flsh_right_slid',
    dots: true,
    autoplay: false,
    responsive: [
      {
...
// FLASH SLIDER ENDED
// ================= FLASH SALE ENDED ===============
// ================= TOP REATED PAER START ===============
$('.rated_slider').slick({
    slidesToShow: 4,
    slidesToScroll: 1,
    prevArrow: '.rate_left_slid',
    nextArrow: '.rate_right_slid',
    dots: true,
    // autoplay: true,
    responsive: [
      {
...
// =============== SINGLE PRODUCT ENDED ================
// ===============  LTS BLOG PART START ================
$('.Ltsblog_posts').slick({
  fade: true,
  slidesToShow: 1,
  slidesToScroll: 1,
  prevArrow: '.lts_sldprev',
  nextArrow: '.lts_sldnext',
  dots: true,
});
...
function checkEmail(input) {
  ...
  if (regExEmail.test(input.value.trim())) {
    ...
    showError(input, 'Pleace input a valid E-mail');
  }
}
...
function checkRequired(inputArr) {
  ...
  inputArr.forEach(function(input) {
    ...
    if (input.value.trim() === '') {
      ...
      showError(input, `${getFieldName(input)} must be same like fast password`);
    } else {
      showSuccess(input);
    }
  });
...
function checkLength(input, min, max) {
  if (input.value.length < min) {
    showError(
      input,
      `${getFieldName(input)}'s must be ${min} characters mixed symble`
    );
...
function checkPasswords(input1, input2) {
  if (input1.value !== input2.value) {
    showError(input2, 'Those posswords dont match');
  } else {
    showSuccess(input);
  }
}
